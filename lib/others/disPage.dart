...
import 'disPostWidget.dart';
import 'disNewPost.dart';
...
class _DiscussionPageState extends State<DiscussionPage> {
  ...
  AppBar _appBarV2() => AppBar(
        title: Text("Discussion Board",
            style: TextStyle(fontFamily: 'Helvetica-Bold')),
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DiscussionAddPost(testUser),
                ),
              );
            },
          ),
  ...
  // //                 ),
  // //             onPressed: () => {
  // //               discussion.addDiscussion(DiscussionBlock(
  // //                 DiscussionData(
