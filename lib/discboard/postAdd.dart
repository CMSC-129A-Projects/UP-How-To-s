...
class _PostInputWidgetState extends State<PostsInputWidget> {
    ...
    return Column(
      children: [
        ...
        TextFormField(
            ...
            validator: (v) {
              if (v.trim().isEmpty) return 'Please enter keywords here';
              return null;
            })
      ],
    );
  ...
  TextFormField _descriptionInput() {
    return TextFormField(
        ...
        validator: (v) {
          if (v.trim().isEmpty) return 'Please enter description here';
          return null;
        });
  }
  ...
  TextFormField _titleInput() {
    return TextFormField(
        ...
        validator: (v) {
          if (v.trim().isEmpty) return 'Please enter title here';
          return null;
        });
  }
