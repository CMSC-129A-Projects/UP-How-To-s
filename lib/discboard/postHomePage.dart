...
import 'package:uphowtos1/discboard/postView.dart';
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PostsInputWidget(newPost),
                    ),
                  );
                },
                icon: Icon(
                  ...
                  switch (item) {
                    case 0:
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => PostsInputWidget.toEdit(contact),
                        ),
                      );
                      break;
                    case 1:
